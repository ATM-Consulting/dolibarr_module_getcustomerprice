...
class modGetCustomerPrice extends DolibarrModules
{
	...
	function __construct($db)
	{
		...
		$this->description = "Utilise les derniers prix pratiqués pour le client";
		...
		$this->const = array(
			...
			1=>array('GETCUSTOMERPRICE_SEARCH_IN_PROPAL','chaine','1','Search price in propal',1,'current', 1),
